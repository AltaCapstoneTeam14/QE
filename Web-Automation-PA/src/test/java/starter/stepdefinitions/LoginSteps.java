...
public class LoginSteps {
    ...
    public void iInputEmail(String email) { loginPage.inputFieldEmail(email);}

    @And("I input {string} password")
    public void iInputPassword(String password) { loginPage.inputFieldPassword(password);}

    @And("I click button login")
    public void iClickButtonLogin() { loginPage.clickButtonLoginAccount();}
